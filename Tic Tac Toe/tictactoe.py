...
def inputPlayerLetter():
    ...
    # Returns a list with the player's letter as the first time, and the computer's letter as the second.
    letter = ''
...
def isWinner(bo, le):
    ...
    return ((bo[7] == le and bo[8] == le and bo[9] == le) or # across the top
            ...
            (bo[1] == le and bo[2] == le and bo[3] == le) or # down the left side
